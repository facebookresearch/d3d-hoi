...
def initialize_render(device, focal_len, img_square_size, img_small_size):
    ...
    focal_len_small = int(focal_len/shrink_ratio)
    ...
    camera_sfm_small = PerspectiveCameras(
                focal_length=((focal_len_small, focal_len_small),),
...
def save_img(idx):
    ...
    mask_img_blend = np.clip(mask_img_blend, 0.0, 1.0)
...
def get_3d_box(box_size, R, center):
