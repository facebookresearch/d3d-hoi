        ...
        if objdets.any() == None or handdets.any() == None:
            ...
            if len(handdets) == 1:
                ...
                if state <= 2:
                    ...
                    center_ratio, size_ratio, flow_dist, withinmask, lr, mask_coverage = gather_info(image, handdets[0], obj_bbox, 50)
                ...
                for hand_id, handdet in enumerate(handdets):
                    ...
                    if hand_obj_id >= 0 and handdet[5]>2:
                        ...
                        center_ratio, size_ratio, flow_dist, withinmask, lr, mask_coverage = gather_info(image, handdet, obj_bbox, 50)
                        annotate={}
