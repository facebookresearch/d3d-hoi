...
cad_path = '/home/xuxiangx/research/johmr/code/JOHMR_data/cad_v3/storageFurniture'
data_path = "/home/xuxiangx/research/johmr/code/JOHMR_data/data_v5.2/storageFurniture"
...
def render(video):
    ...
    ############################
    ##  wire rgb front
    eft_cmd = 'python -m demo.demo_bodymocapnew --render wire --orig 0 --bg rgb --side 1 --videoname '+vidname+' --vPath '+vidpath+' --cadpath '+cad_path
    os.system(eft_cmd)
